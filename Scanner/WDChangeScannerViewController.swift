//
//  WDChangeScannerViewController.swift
//  xmksBg
//
...
import Alamofire
import SnapKit
class WDChangeScannerViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, UIAlertViewDelegate, UITableViewDelegate, UITableViewDataSource{
    
    var scannerLineTop:Constraint? = nil //5423
